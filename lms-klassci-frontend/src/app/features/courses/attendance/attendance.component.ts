      ...
      <div class="attendance-container">
        <lg-liquid-glass-card variant="large" [opacity]="15" blur="lg">
          <div class="content">
            ...
            <p>Système de prise de présence pour les cours.</p>
            <p>Fonctionnalités prévues :</p>
            <ul>
              <li>• Prise de présence rapide</li>
              <li>• Liste des étudiants</li>
              <li>• Historique des présences</li>
              <li>• Statistiques d'assiduité</li>
              <li>• Justification d'absences</li>
            </ul>
          </div>
